...
def breakout_identify(df):
    ...
    if all(last_4_closes > resistance) and all(next_5['close'] > resistance):
        return "bullish_breakout"

    # Check for bearish breakout
    if all(last_4_closes < support) and all(next_5['close'] < support):
